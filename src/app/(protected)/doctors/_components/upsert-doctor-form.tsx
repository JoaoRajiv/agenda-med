...
const formSchema = z
	...
	.refine(
		(data) => {
			const {
				availableFromTime: horaDeInicio,
				availableToTime: horaDeTérmino,
			} = data;
			// Verifica se a hora de início é menor que a hora de término
			return horaDeInicio < horaDeTérmino;
		},
		{
			message:
								...
								<AlertDialogContent>
									<AlertDialogHeader>
										...
										<AlertDialogDescription>
											...
											associadas a esse médico também serão deletadas.
										</AlertDialogDescription>
									</AlertDialogHeader>
									<AlertDialogFooter>
