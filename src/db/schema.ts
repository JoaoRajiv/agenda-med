...
export const doctorsTable = pgTable(
	...
	(table) => [index("doctors_clinic_idx").on(table.clinicId)],
);
...
export const patientsTable = pgTable(
	...
	(table) => [index("patients_clinic_idx").on(table.clinicId)],
);
...
export const appointmentsTable = pgTable(
	...
	(table) => [
		index("appointments_clinic_date_idx").on(table.clinicId, table.date),
